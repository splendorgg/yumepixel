    ...
    return (
        <Section className="overflow-hidden" id="pricing">
            <div className="container relative z-2">
                ...
                <Heading title="Pay once, use forever" tag="Get started with YumePixel" />
                ...
                <div className="flex justify-center mt-10 ">
                    <a className="text-xs font-code font-bold tracking-wider uppercase border-b cursor-pointer">See the full details</a>
                </div>
            </div>
        </Section>
    )
